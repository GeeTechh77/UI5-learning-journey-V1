		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapui5developmentlearningjourneyv1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5developmentlearningjourneyv1-display": {
								"semanticObject": "sapui5developmentlearningjourneyv1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5developmentlearningjourneyv1",
									"url": sap.ui.require.toUrl("sapui5developmentlearningjourneyv1")
								}
							}
						}
					}
